        ...
        public override bool active
        {
            get
            {
                ...
                return model.enabled
                       ...
                       && IsSupportedGraphicsDevice()
                       && !context.interrupted;
            }
        }

        static bool IsSupportedGraphicsDevice()
        {
#if UNITY_2023_1_OR_NEWER
            return true;
#else
            return SystemInfo.graphicsDeviceType != GraphicsDeviceType.OpenGLES2; // No movecs on GLES2 platforms
#endif
        }
