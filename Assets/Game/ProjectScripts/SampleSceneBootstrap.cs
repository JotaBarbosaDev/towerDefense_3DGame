...
public class SampleSceneBootstrap : MonoBehaviour
{
    const string HealthBarPrefabPath =
        "Assets/Game/Prefabs/UI/HealthBar.prefab";
    const string BuggyVisualPrefabPath =
        "Assets/Game/Models/Units/Buggy.fbx";
    const string TankVisualPrefabPath =
        "Assets/Game/Models/Units/HoverTank_Base.fbx";
    const string HelicopterVisualPrefabPath =
        "Assets/Game/Models/Units/Helicopter.fbx";
    const string BossVisualPrefabPath =
        "Assets/Game/Models/Units/BossTank_Base.fbx";
    const string MachineGunTowerPrefabPath =
        "Assets/Game/Prefabs/Towers/MachineGun/MachineGunTower.prefab";
    const string LaserTowerPrefabPath =
        "Assets/Game/Prefabs/Towers/Laser/LaserTower.prefab";
    const string RocketTowerPrefabPath =
        "Assets/Game/Prefabs/Towers/Rocket/RocketTower.prefab";
    ...
    {
        if (Object.FindAnyObjectByType<SampleSceneBootstrap>() != null)
        {
            return;
        }
    ...
    {
        var currencyManager = Object.FindAnyObjectByType<SimpleCurrencyManager>();
    ...
    {
        var buildManager = Object.FindAnyObjectByType<SimpleBuildManager>();
