...
public class CampaignLevelBootstrap : MonoBehaviour
{
    ...
    static void AutoCreate()
    {
        ...
        if (Object.FindAnyObjectByType<CampaignLevelBootstrap>() != null)
        {
            return;
        }
    ...
    void Awake()
    {
        ...
        m_LevelManager = Object.FindAnyObjectByType<LevelManager>();
    ...
    void ApplyDifficultyToLevel()
    {
        ...
        Agent[] existingAgents = Object.FindObjectsByType<Agent>(FindObjectsSortMode.None);
    ...
    void ScaleCurrency()
    {
        ...
        int scaledCurrency = Mathf.RoundToInt(m_LevelManager.startingCurrency * GetDifficultyCurrencyMultiplier());
    ...
    void ScaleHomeBases()
    {
        ...
        float multiplier = GetDifficultyHomeBaseHealthMultiplier();
    ...
    float GetDifficultyCurrencyMultiplier()
    {
    ...
    float GetDifficultyHomeBaseHealthMultiplier()
    {
        switch (m_DifficultyConfig.difficulty)
        {
            case Level1Difficulty.Easy:
