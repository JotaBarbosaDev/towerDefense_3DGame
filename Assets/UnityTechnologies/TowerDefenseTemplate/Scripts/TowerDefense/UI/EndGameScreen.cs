...
namespace TowerDefense.UI
{
	...
	public class EndGameScreen : MonoBehaviour
	{
		...
		public void RestartLevel()
		{
			...
			global::Level1GameSession.RequestLevelStart(global::Level1GameSession.selectedDifficulty, currentSceneName);
		...
		public void GoToNextLevel()
		{
			...
			global::Level1GameSession.RequestLevelStart(global::Level1GameSession.selectedDifficulty, nextLevel.sceneName);
		...
		protected void OpenEndGameScreen(string endResultText)
		{
			...
			global::CampaignProgression.SetStarsForScene(SceneManager.GetActiveScene().name, score);
			if (level != null) 
			{
